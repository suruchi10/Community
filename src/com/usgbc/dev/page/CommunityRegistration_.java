...
//	@FindBy(id = "edit-community-name")private WebElement Community_Name;
    ...
    public By Street_Address = By.xpath(".//*[@class='address-line1 form-text']");
    public WebElement getStreet_Address() {
    	return driver.findElement(Street_Address);
    }
    public By Street_Address2 = By.xpath(".//*[@class='address-line2 form-text']");
    ...
    public By State = By.xpath(".//*[@class='administrative-area form-select']");
